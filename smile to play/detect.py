#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# reference: https://towardsdatascience.com/facial-recognition-happiness-bbb3c4293d1d
import cv2
import keyboard
...
def detection(grayscale, img):
    ...
    for (x_face, y_face, w_face, h_face) in face:
        ...
        eye = cascade_eye.detectMultiScale(ri_grayscale, 1.2, 15) 
        for (x_eye, y_eye, w_eye, h_eye) in eye:
            cv2.rectangle(ri_color,(x_eye, y_eye),(x_eye+w_eye, y_eye+h_eye), (0, 180, 60), 2) 
        smile = cascade_smile.detectMultiScale(ri_grayscale, 1.7, 28)
